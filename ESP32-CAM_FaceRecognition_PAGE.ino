...
//輸入WIFI連線帳號密碼
const char* ssid = "sunday";
const char* password = "05130205";

//輸入AP端連線帳號密碼  http://192.168.4.1
const char* apssid = "sunday-esp";
const char* appassword = "05130205";         //AP密碼至少要8個字元以上  
...
//設定人臉辨識顯示的人名
String recognize_face_matched_name[7] = {"Ming","Name1","Name2","Name3","Name4","Name5","Name6"};
